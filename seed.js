...
(async function(){
    ...
    const ingredients = await Ingredient.create([
        ...
        {ingredientName: 'Bread', safeToEat: 'Depends', images: 'Filler', citations: [{citationName: 'https://www.rover.com/blog/can-my-dog-eat-that/', citeTitle: 'Rover' }, {citationName: 'https://www.foodsdogscaneat.com/', citeTitle:'FoodsDogsCanEat'}]},
        ...
        {ingredientName: 'Apricot', safeToEat: 'Depends', images: 'Filler', citations: [{citationName: 'https://www.rover.com/blog/can-my-dog-eat-that/', citeTitle: 'Rover' }, {citationName: 'https://www.foodsdogscaneat.com/', citeTitle:'FoodsDogsCanEat'}]},
        ...
        {ingredientName: 'Bell Peppers', safeToEat: 'Depends', images: 'Filler', citations: [{citationName: 'https://www.rover.com/blog/can-my-dog-eat-that/', citeTitle: 'Rover' }, {citationName: 'https://www.foodsdogscaneat.com/', citeTitle:'FoodsDogsCanEat'}]},
        ...
        {ingredientName: 'Asparagus', safeToEat: 'Depends', images: 'Filler', citations: [{citationName: 'https://www.rover.com/blog/can-my-dog-eat-that/', citeTitle: 'Rover' }, {citationName: 'https://fluentwoof.com/foods-dogs-cant-eat/', citeTitle:'Fluentwoof'}]},
        ...
        {ingredientName: 'Dates', safeToEat: 'Depends', images: 'Filler', citations: [{citationName: 'https://www.rover.com/blog/can-my-dog-eat-that/', citeTitle: 'Rover' }, {citationName: 'https://www.foodsdogscaneat.com/', citeTitle:'FoodsDogsCanEat'}]},
        {ingredientName: 'Tomatoes', safeToEat: 'Depends', images: 'Filler', citations: [{citationName: 'https://www.rover.com/blog/can-my-dog-eat-that/', citeTitle: 'Rover' }, {citationName: 'https://www.foodsdogscaneat.com/', citeTitle:'FoodsDogsCanEat'}]},
